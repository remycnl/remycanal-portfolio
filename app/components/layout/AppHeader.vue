<template>
	<header class="pointer-events-none fixed inset-x-0 top-5 z-50 flex justify-center px-4">
		<div
			ref="boxRef"
			class="pointer-events-auto flex flex-col overflow-hidden rounded-4xl bg-black px-6 py-2.5 transition-[padding-left,padding-right] duration-400 lg:hover:px-10"
		>
