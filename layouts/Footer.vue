<template>
	...
	<div class="bottom-0 text-white bg-black">
		<div class="container mx-auto px-4 pt-40 pb-20 flex flex-col items-center gap-y-32">
			<img src="~/assets/img/fullLogo.png" alt="Rémy Canal" class="w-60 lg:w-60 h-auto" />
			<div
			...
			<div class="flex justify-center gap-x-6 md:gap-x-10">
				<a
					...
					class="z-10 bg-primary rounded-full border border-secondary-purple hover:border-primary transition duration-300 hover:shadow-around hover:shadow-secondary-purple p-4">
					<Icon name="uil:phone" color="white" class="w-6 h-6 md:w-8 md:h-8" />
				</a>
				<a
				...
				<a
					...
					class="z-10 bg-primary rounded-full border border-secondary-purple hover:border-primary transition duration-300 hover:shadow-around hover:shadow-secondary-purple p-4">
					<Icon name="uil:github" color="white" class="w-6 h-6 md:w-8 md:h-8" />
				</a>
                <a
                    ...
                    rel="noopener noreferrer"
					class="z-10 bg-primary rounded-full border border-secondary-purple hover:border-primary transition duration-300 hover:shadow-around hover:shadow-secondary-purple p-4">
					<Icon name="uil:linkedin" color="white" class="w-6 h-6 md:w-8 md:h-8" />
				</a>
			</div>
